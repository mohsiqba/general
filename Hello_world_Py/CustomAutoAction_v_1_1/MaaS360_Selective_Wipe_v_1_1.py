...
class  MaaS360_Selective_Wipe_Action(object):
    ...
    def __init__(self):
        ...
        MaaS360_Selective_Wipe_Action.maas_domain=sys.argv[1]
        MaaS360_Selective_Wipe_Action.billingId=sys.argv[2]
        MaaS360_Selective_Wipe_Action.appId=sys.argv[3]
        MaaS360_Selective_Wipe_Action.platformId=sys.argv[4]
        MaaS360_Selective_Wipe_Action.appAccessKey=sys.argv[5]
        MaaS360_Selective_Wipe_Action.appVersion=sys.argv[6]
        MaaS360_Selective_Wipe_Action.username=sys.argv[7]
        MaaS360_Selective_Wipe_Action.password=sys.argv[8]        
        MaaS360_Selective_Wipe_Action.deviceId=sys.argv[9]

        
        if MaaS360_Selective_Wipe_Action.maas_domain is None or MaaS360_Selective_Wipe_Action.maas_domain == 'null' or MaaS360_Selective_Wipe_Action.protocol not in MaaS360_Selective_Wipe_Action.maas_domain:
    ...
    def frame_auth_url(self):
        return MaaS360_Selective_Wipe_Action.maas_domain+MaaS360_Selective_Wipe_Action.maas_auth_url+MaaS360_Selective_Wipe_Action.billingId+'/'
    ...
    def frame_action_url(self):
        return MaaS360_Selective_Wipe_Action.maas_domain+MaaS360_Selective_Wipe_Action.maas_service_url+MaaS360_Selective_Wipe_Action.maas_service_action+'/'+MaaS360_Selective_Wipe_Action.billingId+'/'
