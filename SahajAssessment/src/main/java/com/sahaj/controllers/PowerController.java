...
/**
 * 
 * Observes the {@link Motion} events
 * generated by the Sensors, prints the Hotel state on every external input,
 * adjusts the state of the Floors based on the {@link PowerConsumptionRule}
 * 
 *
 */
public class PowerController implements Observer {
	...
	private boolean isPowerConsumptionExceededForFloor(Floor floor) {
		PowerConsumptionRule powerConsumptionCriteria = new PowerConsumptionRule();
		return !powerConsumptionCriteria.isRulesApplicable(floor);
	}
